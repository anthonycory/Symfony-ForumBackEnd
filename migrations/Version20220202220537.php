 ...
 */
final class Version20220202220537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD user_id INT DEFAULT NULL, ADD post_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments DROP user_id, DROP post_id, CHANGE response response LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
