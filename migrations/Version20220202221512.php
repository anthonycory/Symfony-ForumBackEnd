 ...
 */
final class Version20220202221512 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments DROP created_at, CHANGE response response LONGTEXT `utf8mb4_unicode_ci`');
